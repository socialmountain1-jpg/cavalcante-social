        ...
        <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="max-w-[220px] text-xs leading-relaxed text-[#64748B]">
              Estratégia digital que transforma marcas em referências.
            </p>
          </div>

          {/* Centro — links de navegação */}
          <nav className="flex flex-col gap-3">
            <p className="mb-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-[#64748B]">Navegação</p>
            {[
          ...
          <div className="flex flex-col gap-3">
            <p className="mb-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-[#64748B]">Redes Sociais</p>
            <a
